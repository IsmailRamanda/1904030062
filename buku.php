...
$perpus = query("SELECT * FROM perpustakaan");
...
<html lang="en">
    ...
    <body id="page-top">
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#page-top">Buku</a></li>
        ...
        <div class="col-md-15 p-5 pt-19">
            <br>
            <!-- Konten -->
            <h3><i class="fas fa-users"></i> <br>Daftar Buku</h3>
            <hr>
            <!-- Pencarian data -->
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <?php $no = 1; ?>
                    <?php foreach ($perpus as $pps) : ?>
                        <tr>
                            <th scope="row"><?php echo $no; ?></th>
                            <td><?php echo $pps['judul']; ?></td>
                            <td><?php echo $pps['pengarang']; ?></td>
                            <td><a href="detail.php?id=<?= $pps['id']; ?>" class="btn btn-warning" role="button">detail</a></td>
                        </tr>
                        <?php $no++ ?>
                    <?php endforeach ?>
                </tbody>

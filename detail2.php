...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <div class="col-md-10 p-5 pt-5">
            <!-- Konten -->
            <h3><i class="fas fa-users"></i> <br>Detail Anggota perpustakaan</h3>
            <hr>
            <ul class="list-group">
                <li class="list-group-item"><img src= "assets/img/<?= $anggota['foto_anggota']; ?>" width="240 px" alt=""></li>
                <li class="list-group-item">Nama :<?= $anggota['nama']; ?></li>
                <li class="list-group-item">Jenis Kelamin :<?= $anggota['jenis_kelamin']; ?></li>
                <li class="list-group-item">Id Anggota : <?= $anggota['id_anggota']; ?></li>
                <li class="list-group-item">Alamat  : <?= $anggota['alamat']; ?></li>
                <li class="list-group-item">Tingkatan : <?= $anggota['tingkatan']; ?></li>
                <li class="list-group-item">Tanggal Lahir : <?= $anggota['tanggal_lahir']; ?></li>
                <li class="list-group-item">No. Hp : <?= $anggota['no_hp']; ?></li>
                <li class="list-group-item">
                    <a href="edit2.php?id=<?= $anggota['id']; ?>" class="btn btn-warning" role="button">Edit</a> |
                    <a href="hapus2.php?id=<?= $anggota['id']; ?>" onclick="return confirm('Apakah anda yakin akan menghapus data ini?');" class="btn btn-danger" role="button">Hapus</a> |
